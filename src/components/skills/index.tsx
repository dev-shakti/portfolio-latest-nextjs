...
export default function Skills() {
  ...
  return (
    <section ref={ref}  className="px-6 py-12 md:py-16 w-full">
     ...
     {/* Heading Animation */}
      ...
      className="w-full max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8">
          ...
          >
            <Card className="rounded-xl shadow-lg hover:shadow-2xl p-6 bg-white cursor-pointer transition-all duration-300 hover:scale-105">
              <CardContent className="">
                ...
                <h4 className="text-lg font-semibold text-gray-700 tracking-tight leading-tight mt-5">
                  {skill.title}
                </h4>
              </CardContent>
            </Card>
