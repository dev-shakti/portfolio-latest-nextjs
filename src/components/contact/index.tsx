       ...
       >
        ...
        <motion.form
         ...
         variants={{
          ...
          className=" bg-slate-100 p-6 shadow-lg rounded-xl"
        >
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className="w-full mt-1 p-2 border resize-none border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <Button
              type="submit"
              className="w-full px-4 py-2 text-white rounded-lg bg-blue-600 hover:bg-blue-700 hover:scale-105 transition-all ease-in-out duration-300"
            >
              Submit
            </Button>
          </div>
